	...
	return (
		<div className="flex min-h-screen flex-col">
			...
			<Suspense>
				...
				<Switch>
					<Route path="/">
						<main id="main-content" className="flex-1 bg-[#fafaf9] dark:bg-[#0c0a09]">
							<HomePage />
						</main>
					</Route>

					<Route path="/docs" nest>
						<div className="flex-1 bg-[#fafaf9] dark:bg-[#0c0a09]">
							<Suspense
								fallback={
					...
					<Route>
						<div className="flex-1 bg-[#fafaf9] dark:bg-[#0c0a09] flex items-center justify-center">
							<div className="text-center">
								<h1 className="text-4xl font-bold mb-4 text-stone-900 dark:text-stone-100">404</h1>
								<p className="text-xl text-stone-600 dark:text-stone-300">Page not found</p>
							</div>
						</div>
					</Route>
				</Switch>
